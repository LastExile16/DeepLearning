...
def get_model_transfer_learning(model_name="resnet18", n_classes=50, weight='ResNet18_Weights.DEFAULT'):

    # Get the requested architecture
    if hasattr(models, model_name):

        model_transfer = getattr(models, model_name)(weights=get_weight(weight))
