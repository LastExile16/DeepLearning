...
def get_data_loaders(
    ...
    train_data = datasets.ImageFolder(
        base_path / "train",
        data_transforms['train'] # YOUR CODE HERE: add the appropriate transform that you defined in
    ...
    valid_data = datasets.ImageFolder(
        base_path / "train",
        data_transforms['valid'] # YOUR CODE HERE: add the appropriate transform that you defined in
        # the data_transforms dictionary
    )
    ...
    test_data = datasets.ImageFolder(
        base_path / "test",
        data_transforms['test'] # YOUR CODE HERE (add the test transform)
    )
    ...
    data_loaders["test"] = torch.utils.data.DataLoader(
        test_data, # YOUR CODE HERE (remember to add shuffle=False as well)
